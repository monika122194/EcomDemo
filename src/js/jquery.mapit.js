...
;(function($, window, undefined) {
	...
	$.fn.mapit = function(options) {
		...
		var defaults = {
			...
			address: '<div class="map-marker"><h2 class="ultrabold dark f-normal no-margin-bottom">The HAI App Studio</span></h2><p class="light gray2 no-margin-bottom">849 Strawberry Ave. Athens, GA 30605</p></div>',
			styles: 'GRAYSCALE',
			origins: [
				['37.936294', '23.947394'],
				['37.975669', '23.733868']
